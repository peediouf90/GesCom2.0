...
const TABLES = {
  produits: {
    ...
    versDb: (p) => ({
      ...
      prix_demi_gros: p.prixDemiGros ?? null,
      prix_gros: p.prixGros ?? null,
    ...
    depuisDb: (r) => ({
      ...
      prixDemiGros: r.prix_demi_gros !== null && r.prix_demi_gros !== undefined ? Number(r.prix_demi_gros) : null,
      prixGros: r.prix_gros !== null && r.prix_gros !== undefined ? Number(r.prix_gros) : null,
